...
const CustomLiveSurvey = props => {
  const {headFirstText, dollar, name, desrp, time, onPress, currencyValue} =
    props;
    ...
    <View style={[styles.paddH15PaddB15]}>
      <View style={styles.lSFirstViewMain}>
        ...
        <View style={styles.rowCenter}>
          <FastImage
            style={styles.lSurvStarStyle}
            source={GlobalImages.starIcon}
          />
      ...
      <View style={styles.middleView}>
        <View style={styles.mar12}>
          ...
          <View style={styles.rowCenterSpaceBetw}>
            <View style={styles.rowCenter}>
              <FastImage
                style={styles.cLSClockIconstyle}
                source={GlobalImages.clockTimeICon}
              />
              <Text style={styles.cLSTimeTextStyle}>{time}</Text>
            </View>
            <View style={styles.rowCenter}>
              <FastImage
                style={styles.cLSDeskTStyle}
                source={GlobalImages.desktopIcon}
              />
              <FastImage
                style={styles.cLSCellPhonStyle}
                source={GlobalImages.cellPhoneIcon}
              />
              <FastImage
                style={styles.cLSTabletStyle}
                source={GlobalImages.tabletIcon}
              />
            </View>
          </View>
          <View style={styles.marT16}>
            <CustomButton
              needImageinButton
              buttonName={I18n.t(globalText.takeSurvey)}
              onPress={onPress}
            />
          </View>
        </View>
