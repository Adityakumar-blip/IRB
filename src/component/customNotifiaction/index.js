        ...
        <View style={styles.cNMiddleView}>
          <View style={styles.width80Per}>
            <Text
              style={[
                read == 1
                  ? styles.cNdescrpTextStyleRead
                  : styles.cNdescrpTextStyle,
              ]}>
              {descrp}
            </Text>
            {checkName == 'new_poll_available' && (
              <TouchableOpacity onPress={onPressCheckOut}>
                <Text style={styles.cNMsgTextStyle}>
                  {I18n.t(globalText.checkItOut)}
                </Text>
              </TouchableOpacity>
            )}
            {checkName == 'refer_more_user' && (
              <TouchableOpacity onPress={onPressCheckOut}>
                <Text style={styles.cNMsgTextStyle}>
                  {I18n.t(globalText.referYourFriend)}
                </Text>
              </TouchableOpacity>
            )}
            {checkName == 'new_survey_available' && (
