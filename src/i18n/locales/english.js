export default {
  ...
  piiDesc:
    'Please Note: If you check this option you will not be able to use our services viz. surveys etc. But we will still be able to use services like email or SMS to communicate with you. If you do not wish to continue with any of these services please',
  unsubscribe: 'Unsubscribe',
  unsubscribequestion: 'Are you sure to close your Opinion Bureau account?',
  yes: 'Yes',
  no: 'No',
  unsubscribeDescription:
    'Unsubscribing from Opinion Bureau will disable your profile, lapse your earned amount, cancel redemption request and cancel all other requests made to help desk.If you are sure to unsubscribe your account, we would like to hear your feedback about Opinion Bureau which would help us improving the survey experience for our members.\n\nType your feedbackhere!',
  referFriend:
    'Refer your friends, colleagues and family to Opinion Bureau and earn extra for every successful qualification.You can earn xx in five simple steps',
  ...
  doYouWantToShareThisPollOrEntirePollCatalogues:
    'Do you want to share this poll or entire poll catalogue?',
  ...
  sorry: 'Sorry!',
  weAreAvlCountry:
    ' We are not availabale in your country right now. see the list of active countries ',
  here: 'here',
  ...
  weWelcomTextPrivacy:
    'We welcome you to join Opinion Bureau Survey community. Please be informed that:',
  privcyFirstPoint:
    '1. We are GDPR (General Data Protection Regulation) Complaint.',
  privcySecondPoint:
    '2. We required your personal information i.e. name, email, gender, DOB, phone no and address during the regestration process.',
  privcyThirdPoint:
    '3. We use the set of information provided by you for profiling, relevant survey identification, follow-ups, omitting, duplicate/ repetitive survey attempts and issuing rewards to you.',
  privcyFourPoint:
    '4. This information is shared with our clients or third parties (market research and product/service companies) only with your consent. We ensure that our client erase the information from their data-base as soon as the purpose of research is met.',
  iAgree: 'I agree',
  iDontAgree: "I don't agree",
  whichOfTheFollEvent:
    'Which of the following events did you do you in past 12 months or planning to do next 12 months?',
  howManyPets: 'How many pets, if any, do you have?',
  hightestLevelOfEdu: 'Highest Level of Education',
  bachDegree: 'Bacholers Degree',
  ...
  dot: '.',
  appExitMessage: 'Are you sure want to exit',
  impSymbol: '*',
  male: 'Male',
  female: 'Female',
  other: 'Other',
  ...
  entirePoleCatlogMessage:
    'Check out this series of exciting polls on Opinion Bureau and share your opinion with the world.',
  ...
  _redemptionSuccessMessage:
    'Your Request for redemption has been submitted successfully',
  _pointConversionLimitMessage: 'You can convert more than',
  _pointConversionSuccessMessage:
    'Your Request for point conversion has been submitted successfully',
  ...
  _verify: 'Verify',
  _updatedSucessfully: 'updated sucessfully', //
  _The: 'The',
  _category: 'Category',
  _Hi: 'Hi',
  _goToThe: 'Go to the',
  ...
  _converPointLimitMsg:
    'You can convert more than {{_redemptionPoint}} points at a time.',
  _redeemPointLimitMsg:
    'You can redeem more than {{_threesholdLimit}} points at a time.',
  _redemptionSuccessMsg:
    'Your Request for redemption has been submitted successfully', //
  _pleaseSelectAtleastOneAnswer: 'Please select atleast one answer',
  _pleaseSelectTheCheckbox: 'please select the checkbox',
  _yourOtpIs: 'Your otp is {{_otp}}',
  _dashbaordTextThisIsYourStatistics:
    'This is your statistics for year {{_year}}',
  _dashbaordComplition:
    'Your profile completion rate is at {{_percentage}}. Your complete profile helps us find you more and relevant surveys to help you earn more points.',
  _livesurveyCountMsg:
    'We have found {{_count}} live surveys for you basis your profile and interests. Update your profile regularly to get more surveys. Happy earning!',
  _basicProfileMemberSince: 'Member since {{_year}}',
  _voteSucessfully: 'Vote Sucessfully',
  ...
  _yourRewardHasBeenRejectedOnQuality:
    'Your reward has been rejected on quality.',
  ...
  _mobileOTPIsIncorect: 'Mobile OTP is incorect',
  _emailOTPIsIncorect: 'Email OTP is incorect',
  _pleaseAgreePrivacyPolicy: 'Please Agree Privacy Policy.',
  _areYouSureWantToLogout: 'Are you sure want to logout?',
  _passwordErrorMessage:
    'Your password must have at least 8 characters with one number and one special character and one alphabet.',
  _passwordValidationMessage:
    'Your password must have at least 8 characters with one number and one special character.',
  ...
  _pleaseSendTheCodeForThisMobileNumbner:
    'Please send the OTP for this mobile number',
  ...
  _pleaseEnterConfirmPasswordVallidationMessage:
    'Your confirm password must have at least 8 characters with one number and one special character and one alphabet.',
  ...
  faqRewardsQuestionOne:
    'It has been over ten days, and my reward points have not been credited yet. What to do now?',
  ...
  faqRewardsQuestionThree:
    'What do I do if the survey rewards don’t reflect in my account within stipulated time?',
  ...
  faqRewardsQuestionFour:
    'I completed a survey, and I have not received the amount? Please help.',
  ...
  faqRewardsQuestionFive:
    'Is there a deadline/time of expiry to my reward points?',
  ...
  faqRewardsQuestionSix:
    'Is there anything I need to know about my reward points?',
  ...
  faqMemberShipQuestionFirst:
    'What is the eligibility to become the member of Opinion Bureau survey community?',
  ...
  faqMemberShipQuestionSecond:
    'What is the determining factor in your eligibility',
  ...
  faqMemberShipQuestionThird:
    'What is the relationship of the member of Opinion Bureau survey community with the website?',
  ...
  faqMemberShipQuestionFourth:
    'Can I register with the Opinion Bureau website more than once?',
  ...
  faqMemberShipQuestionSix:
    'Can I seek help from PC software or use the robot to fill up form?',
  ...
  faqMemberShipQuestionEight:
    'I wish to discontinue my survey participation. How can I terminate my account?',
  ...
  faqMemberShipQuestionTen:
    'I paid a committed amount to a third party to join Opinion Bureau community. How will your website compensate it?',
  ...
  faqMemberShipQuestionEeleven:
    'Can I use the reward points even after I have unsubscribed from Opinion Bureau membership?',
  ...
  faqMemberShipQuestionTwelve:
    'What can lead to permanent deregistration of a user’s account',
  ...
  faqSurveyQuestionThree:
    'What are the eligibility criteria to participate in the survey?',
  ...
  faqSurveyQuestionFour:
    'Can I participate in the survey without being a member?',
  ...
  faqRedemptionQuestionThree:
    'What are the options to redeem my reward points?',
  ...
  faqRedemptionQuestionFourth:
    'Can I use the reward points in the form of ecom currencies available with online merchants?',
  ...
  faqRedemptionQuestionFive:
    'How many redemption requests can I make in a day?',
  faqRedemptionQuestionFiveAnswer:
    'You can make a maximum of 3 redemption requests in a day.',
  faqMiscellaneousQuestionOne:
    'How to contact Opinion Bureau.com in case of a query?',
  faqMiscellaneousQuestionOneAnswer:
    'Send a mail to help@opinionbureau.com mentioning your panelist ID. Our team will act on the processing the rewards, in such cases or help you with your related problems',

  //
  rewardsEarned: 'Rewards Earned',
  typeYourFeedBackHere: 'Type your feedback here!',
  clearNotification: 'Clear Notification Suceessfully',
  notificationsUpdatedAsReadSuccessfully:
    'notifications updated as read successfully',
  ...
  eligibaleErrorDateOfBirth:
    'You are not eligible for sign up due to age constraint. Age should be greater than 14',
  passwordhasChangeSucessfuly: 'Password has been successfully changed',
  pleaseEnterEmailIdWhichIsRegisteredWithOpinionBureau:
    'Please enter email id which is registered with Opinion Bureau.',
  ...
  pleaseEnterAtLeastEmailOrMobileOrBoth:
    'Please enter at least email or mobile or both',
  ...
  totalPointConvertRequestInOneDayExceed:
    'Total points convert request in one day exceed',
  ...
  referFriendAndEarnXX:
    'Refer your friends, colleagues, and family to Opinion Bureau and earn extra for every successful qualification.You can earn {{_earn}} in five simple steps',
  ...
  _postCodeErorMessage:
    'Enter {{_digit}} digit valid Zip Code. Example:{{_postCode}}',
  ...
  _timeLimitMsg:
    'Please wait for at least {{_num}} minutes to make another request while we update your request. Please note that you can submit maximum of two requests in a day.',
  _yourNewPassNotSameasWeb:
    'Your new password should not be same to old password.',
  _passwordValidationMessageNew:
    'Your new password must have at least 8 characters with one number and one special character.',
  ...
  _please_fill_email_ids:
    'Fill in their email IDs in the below boxes and hit invite',
  reffer_name: 'Name',
  reffer_email: 'Email',
  _more: 'more',
  _note: 'Note',
  ...
  _you_have_already_refer: 'You Have already reffered to ',
};
