...
import { checkPasswordVallidation, getAsyncStorage, getFormatedDate, toastShow } from '../../utils/customFunctions';
...
const CompleteProfile = props => {
    ...
    const onPageInit = async () => {
        ...
        const data = (await props.route) && props.route.params && props.route.params.data;
        ...
        isData.country_id = language_data.country_id ? language_data.country_id : 236;
        isData.country_code = language_data.country_code ? language_data.country_code : 'US';
    ...
    const onSignUp = async () => {
        ...
        if (isData.phone_no.trim().length == 0 && isData.verification_method == '4') {
        ...
        const payloadData = {
            ...
            gender:
                isData.gender == I18n.t(globalText.male) ? 'M' : isData.gender == I18n.t(globalText.female) ? 'F' : 'O',
        ...
        <CustomBackground
            screen={
                <SafeAreaView>
                    ...
                    >
                        <View style={[styles.loginMainScreen, { height: height }, styles.marM80]}>
                            {isErrorMessage != '' ? (
                            ...
                            <View style={styles.rowTop25}>
                                ...
                                <View style={styles.loginPasswordInputView}>
                                    ...
                                    <View style={[styles.loginPasswordInputView_1, styles.width90PaddL5]}>
                                        <TextInput
                                            ...
                                            returnKeyType={'done'}
                                            // autoFocus={true}
                                            defaultValue={isData && isData.phone_no && isData.phone_no}
                                ...
                                <View style={styles.loginPasswordInputView}>
                                    <View style={styles.loginPasswordInputView_1}>
                                        <TextInput
                                            ...
                                            onBlur={() =>
                                                CustomValidation.onBlurField(simpleValidator, allValid, 'password')
                                            }
                                        />
                                    </View>
                            ...
                            <View style={styles.row}>
                                ...
                                {isDataLoaded && isPasswordError && (
                                    <Text style={[styles.width90, styles.redColorText, styles.paddR15]}>
                            ...
                            <TouchableOpacity style={styles.rowTop25} onPress={() => setAgreement(!agreement)}>
                                <TouchableOpacity
                                    style={[
                            ...
                            {isDataLoaded && !agreement && (
                                <View style={[styles.width90per, styles.alignSelfEnd]}>
                                    <Text style={styles.redTxt}>{I18n.t(globalText._pleaseSelectTheCheckbox)}</Text>
                                </View>
                            )}
                            <View style={styles.loginButtonView}>
                                <AuthButton
                                    buttonName={I18n.t(globalText.signUp)}
                                    leftIcon={<Ionicons name={'person-outline'} size={20} color={colors.WHITE} />}
                                    rightIcon
                                    onPress={() => onSignUp()}
                                />
                            </View>
