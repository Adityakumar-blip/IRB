...
import { Text, TouchableOpacity, View, KeyboardAvoidingView, SafeAreaView, Dimensions } from 'react-native';
import FastImage from 'react-native-fast-image';
import { KeyboardAwareScrollView } from 'react-native-keyboard-aware-scroll-view';
import { setAsyncStorage, removeAsyncStorage, getAsyncStorage, generateOtp } from '../../utils/customFunctions';
...
const Auth = props => {
    ...
    const onPageInit = async () => {
        let country_code = (await props.route) && props.route.params && props.route.params.country_code;
                            ...
                            <View style={styles.authTabView}>
                                ...
                                <TouchableOpacity
                                    style={[
                                        ...
                                        {
                                            backgroundColor:
                                                loginVia == I18n.t(globalText.otp) ? colors.RED_VOILET : colors.WHITE,
                                        },
                                    ]}
                                    onPress={async () => {
