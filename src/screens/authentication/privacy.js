...
const Privacy = props => {
    ...
    const onSaveGdprValue = async value => {
        ...
        const { data, message } = await AuthApi.postDataToServer(Api.signUpGdprStatus, payload);
        setLoader(false);
        if (!data) {
            return;
        }
                        ...
                        <ScrollView style={styles.padd15}>
                            <View style={styles.paddB40}>
                                ...
                                <View>
                                    ...
                                    <Text style={styles.privacyPointText}>{I18n.t(globalText.privcyFirstPoint)}</Text>
                                    <Text style={styles.privacyPointText}>{I18n.t(globalText.privcySecondPoint)}</Text>
                                    <Text style={styles.privacyPointText}>{I18n.t(globalText.privcyThirdPoint)}</Text>
                                    <Text style={styles.privacyPointText}>{I18n.t(globalText.privcyFourPoint)}</Text>
                                </View>
                                ...
                                <View style={styles.privacyLastView}>
                                    <TouchableOpacity style={styles.rowCenter} onPress={() => setAgree('AGREE')}>
                                        <View style={styles.privacyCircleView}>
                                            {isAgree == 'AGREE' && <View style={styles.privacyCircleStyle} />}
                                        </View>
                                        <Text style={styles.privacyAgreeStyle}>{I18n.t(globalText.iAgree)}</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity
                                    ...
                                    >
                                        <View style={styles.privacyCircleView}>
                                            {isAgree == 'DISAGREE' && <View style={styles.privacyCircleStyle} />}
                                        </View>
                                        <Text style={styles.privacyAgreeStyle}>{I18n.t(globalText.iDontAgree)}</Text>
                                    </TouchableOpacity>
                                </View>
