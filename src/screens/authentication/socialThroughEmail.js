...
import { Image, SafeAreaView, Text, TextInput, View, Dimensions, Platform } from 'react-native';
...
const SocialThroughEmail = props => {
    ...
    const onPageInit = async () => {
        ...
        const status = (await props.route) && props.route.params && props.route.params.status;
                                                ...
                                                {simpleValidator.current.message(
                                                    ...
                                                    <Text style={styles.redColorText}>
                                                        {isData.first_name && isData.first_name.length == 1
                                                            ...
                                                            : isData.first_name && isData.first_name.length > 0
                                                            ? I18n.t(globalText._theValueMustBeValid, {
                                                                  _firstValue: I18n.t(globalText.firstName),
                                                                  _lastValue: I18n.t(globalText.name).toLowerCase(),
                                                              })
                                                            : I18n.t(globalText._theMessageMustBeRequired, {
                                                                  _message: I18n.t(globalText.firstName).toLowerCase(),
                                                              })}
                                                    </Text>
                                                )}
                                            </View>
