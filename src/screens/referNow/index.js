                ...
                <View style={styles.latTrllMainModalView}>
                    <TouchableWithoutFeedback onPress={() => {}}>
                        <View style={styles.latTrllMainModalViewStyle}>
                            <Text style={styles.latTrollModalFirstTextStyle}>{I18n.t(globalText.referNow)}</Text>
                            ...
                            <Text style={styles.referNowIviteText}>{I18n.t(globalText.referNowIviteText)}</Text>
